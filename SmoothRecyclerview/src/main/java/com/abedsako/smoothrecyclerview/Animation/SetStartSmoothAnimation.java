...
public class SetStartSmoothAnimation {
    boolean IsWithAlpha;
    boolean IsWithScale;
    ...
    public SetStartSmoothAnimation(float scaleY, float scaleX, float alpha, int duration, int startDelay, boolean isWithStartDelay, boolean isWithScale, boolean isWithAlpha) {
        this.scaleY = scaleY;
        this.scaleX = scaleX;
        this.alpha = alpha;
